...
Tutorial taken from https://github.com/yeshwanthlm/YouTube/blob/main/flask-on-aws-ec2.md

## Summary
### Renaming flask app (.py)
1. Rename the py file
2. Change the .service file name which is located at /etc/systemd/system
3. Inside the file, change ExecStart=/home/ubuntu/<project_directory>/venv/bin/gunicorn -b localhost:8000 <NewName>:app
4. sudo systemctl daemon-reload
5. sudo systemctl start <servie_name>.service
